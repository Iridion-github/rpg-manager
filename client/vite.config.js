...
// These proxies let the frontend call /api, /uploads, /maps, /tokens and
// /socket.io as if same-origin. Override the backend with VITE_API_TARGET to point a dev client
